								...
								{idUser ? (
									<>
										<li className="menu_item_nav">
											<a href={"/Home?id=" + idUser} className="menu_link_nav">
												Home
											</a>
										</li>
										<li className="menu_item_nav">
											<a
												href={"/Profile?id=" + idUser}
										...
										<li className="menu_item_nav">
											<a href="/Login" className="menu_link_nav">
												Logout
											</a>
										</li>
									</>
									...
									<>
										...
										<li className="menu_item_nav">
											<a href="/Signup" className="menu_link_nav">
												Signup
											</a>
										</li>
									</>
						...
						<ul className="menu_nav">
							{idUser ? (
								<>
									...
									<li className="menu_item_nav">
										<a href={"/Profile?id=" + idUser} className="menu_link_nav">
											Profil
										</a>
									</li>
									<li className="menu_item_nav">
