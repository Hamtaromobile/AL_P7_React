...
const Pagination = ({ currentPage, totalPages, handleClick,renderPageNumbers }) => (
  <nav className='container_pagination'>
    <ul className='ul_button_pagination'>
      <li className='li_button_pagination'>
        <a href="javascript:void(0)" onClick={() => handleClick(1)}> <KeyboardDoubleArrowLeftIcon  className='ico_pagination' alt="première page"/></a>
      </li>
      <li className='li_button_pagination'>
      ...
      <li className='li_button_pagination'>
        <a href="javascript:void(0)" onClick={() => handleClick(totalPages)}><KeyboardDoubleArrowRightIcon className='ico_pagination' alt="dernère page" /></a>
      </li>
    </ul>
